...
class DiseasePrediction:
    ...
    def _load_train_dataset(self):
        ...
        print(len(train_features.iloc[0]))
    ...
    def _load_test_dataset(self):
        ...
        # Check for data sanity
        print(len(test_features.iloc[0]))
...
if __name__ == "__main__":
    ...
    dp = DiseasePrediction(model_name=models[3]) #current_model_name_variable_line_163
    # Train the Model
    dp.train_model()
    # Get Model Performance on Test Data
    test_accuracy, classification_report = dp.make_prediction(saved_model_name=models[3]) #Change here Too
